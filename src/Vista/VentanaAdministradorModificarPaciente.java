...
import Control.ControladorAdministradorModificarPacientes;
import Control.ControladorEditarDatos;
import Modelo.Paciente;

public class VentanaAdministradorModificarPaciente {

	public JFrame frmModificarDatos;
	ControladorAdministradorModificarPacientes controlador;
	public JPanel panel_datos_paciente;
	public JButton btn_AP_Aceptar;
	public JButton btn_AP_Cancelar;
	public JButton btn_MP_Inactivo;
	...
	public JTextPane txtN_historial;
	public JTextPane laberN_historial;
	...
	public void addController(ControladorAdministradorModificarPacientes ced) {
	...
	public void crearVentana(Paciente pac){
		...
		frmModificarDatos = new JFrame();
		frmModificarDatos.getContentPane().setFont(new Font("Tahoma", Font.PLAIN, fuenteRelativa(19)));
		frmModificarDatos.getContentPane().setBackground(Color.WHITE);
		frmModificarDatos.setTitle("Editor De Datos");
		frmModificarDatos.setBounds(AnchoRelativo(130), AltoRelativo(70), AnchoRelativo(1700), AltoRelativo(1000));
		frmModificarDatos.addWindowListener(controlador);
		frmModificarDatos.setResizable(false);
	  ...
	  frmModificarDatos.getContentPane().add(btn_AP_Aceptar);
		...
		frmModificarDatos.getContentPane().add(btn_AP_Cancelar);
		
		btn_AP_Cancelar = new JButton("Inactivo");
		btn_AP_Cancelar.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		btn_AP_Cancelar.setFont(new Font("Tahoma", Font.BOLD, fuenteRelativa(21)));	//Establece el tama�o y el tipo de letra que tendr� el bot�n
		btn_AP_Cancelar.setBackground(new Color(0, 0, 96));	//Establece el color del bot�n
		btn_AP_Cancelar.setOpaque(true);
	...
	public void panelDatosPaciente(Paciente pac){
		...
		/*txtN_historial = new JTextPane();
		txtN_historial.setText("N_Historial");
		txtN_historial.setFont(new Font("Tahoma", Font.BOLD, fuenteRelativa(21)));
		txtN_historial.setEditable(false);
		txtN_historial.setBounds(AnchoRelativo(250), AltoRelativo(140), AnchoRelativo(150), AltoRelativo(26));
		panel_datos_paciente.add(txtN_historial);
		
		laberN_historial = new JTextPane();
		laberN_historial.setBackground(Color.WHITE);
		laberN_historial.setText(String.valueOf(pac.getN_historial()));
		laberN_historial.setEditable(true);
		laberN_historial.setBounds(AnchoRelativo(410), AltoRelativo(140), AnchoRelativo(200), AltoRelativo(26));
		panel_datos_paciente.add(laberN_historial);*/
		...
		frmModificarDatos.getContentPane().add(txtpnCondicion);
		...
		frmModificarDatos.getContentPane().add(cb_Condicion);*/
		...
		frmModificarDatos.getContentPane().add(panel_datos_paciente);
		// frame.repaint();
